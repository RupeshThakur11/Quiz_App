...
keystone.set('404', function(req, res, next) {
    res.send('<h1>Not Found</h1><br>Tell To Rupesh Thakur(Admin)');
});
...
keystone.set('500', function(err, req, res, next) {
    ...
    res.send('<h1>Page Not Found<br>you have error</h1><br>Tell To Rupesh Thakur' + err, title, message);
});
...
exports = module.exports = function(app) {
    ...
    app.get('/gallery', routes.api.gallery);
    app.get('/findus', routes.api.findus);
    app.all('/contact', routes.api.contact);
